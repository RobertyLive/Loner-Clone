...
<Package xmlns="http://schemas.microsoft.com/developer/2004/01/bootstrapper" Name="DisplayName" Culture="Culture" LicenseAgreement="eula.rtf">
  ...
  <PackageFiles CopyAllPackageFiles="false">
    ...
    <PackageFile Name="NDP47-KB3186497-x86-x64-AllOS-TRK.exe" HomeSite="DotNetFX47FullLanguagePackBootstrapper" PublicKey=""/>
  </PackageFiles>
  <InstallChecks>
    <RegistryCheck Property="DotNet47FullLangPack_Release" Key="HKLM\Software\Microsoft\NET Framework Setup\NDP\v4\Full\1055" Value="Release"/>
    <RegistryCheck Property="DotNet47FullLangPack_OS_LCID" Key="HKLM\SYSTEM\CurrentControlSet\Control\MUI\UILanguages\tr-TR" Value="LCID"/>
  ...
  <Commands>
    <Command PackageFile="NDP47-KB3186497-x86-x64-AllOS-TRK.exe" Arguments=" /q /norestart /skipenucheck /ChainingPackage FullX64ClickOnce" EstimatedInstalledBytes="130718421" EstimatedTempBytes="77473415" EstimatedInstallSeconds="90">
    ...
    <Command PackageFile="NDP47-KB3186497-x86-x64-AllOS-TRK.exe" Arguments=" /q /norestart /skipenucheck /ChainingPackage FullX64ClickOnce" EstimatedInstalledBytes="130718421" EstimatedTempBytes="77473415" EstimatedInstallSeconds="90">
      ...
      <InstallConditions>
        ...
        <BypassIf Property="DotNet47FullLangPack_OS_LCID" Compare="ValueNotEqualTo" Value="1055"/>
        <!-- Block install if user does not have admin privileges -->
        <FailIf Property="AdminUser" Compare="ValueEqualTo" Value="false" String="AdminRequired"/>