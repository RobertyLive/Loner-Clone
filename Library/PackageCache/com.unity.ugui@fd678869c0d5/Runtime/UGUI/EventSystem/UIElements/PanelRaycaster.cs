...
<ProjectSchemaDefinitions xmlns="http://schemas.microsoft.com/build/2009/properties">
    ...
    <ContentType Name="Text" DisplayName="텍스트 파일" ItemType="Content">
    </ContentType>

    <ContentType Name="XML" DisplayName="XML 파일" ItemType="Content">
    </ContentType>

    <ContentType Name="HTML" DisplayName="HTML 파일" ItemType="Content">
    </ContentType>

    <ContentType Name="CSS" DisplayName="CSS 스타일시트" ItemType="Content">
    </ContentType>

    <ContentType Name="Json" DisplayName="Json 파일" ItemType="Content">
    </ContentType>

    <ContentType Name="Font" DisplayName="글꼴 파일" ItemType="Content">
    </ContentType>

    <ContentType Name="Media" DisplayName="미디어 파일" ItemType="Content">
    </ContentType>
    
    <ContentType Name="Image" DisplayName="이미지 파일" ItemType="Content">
    </ContentType>
